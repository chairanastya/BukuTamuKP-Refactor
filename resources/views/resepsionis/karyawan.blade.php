        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between mb-6 header-container">
                ...
                <div class="header-buttons-container">
                    <x-button 
                        variant="primary" 
                        :href="route('resepsionis.karyawan.create')"
                    >
                ...
                columns: [
                    ...
                    { data: 'jabatan', responsivePriority: 5 },
                    {
                        ...
                        render: function (data) {
                            const type = data ? 'resepsionis' : 'karyawan';
                            return `<span class="badge px-3 py-1.5 text-xs rounded-lg font-semibold inline-block ${
                                data ? 'bg-[#DBEAFE] text-[#193CB8]' : 'bg-[#E5E7EB] text-[#374151]'
                            }">${data ? 'Resepsionis' : 'Karyawan'}</span>`;
                        }
                    },
                    {
                        data: 'status',
                        ...
                        render: function (data) {
                            ...
                            return `<span class="badge px-3 py-1.5 text-xs rounded-lg font-semibold inline-block ${
                                isAktif ? 'bg-[#D1FAE5] text-[#059669]' : 'bg-[#FEE2E2] text-[#DC2626]'
                            }">${isAktif ? 'Aktif' : 'Nonaktif'}</span>`;
                        }
                    },
                    {
                        data: null,
