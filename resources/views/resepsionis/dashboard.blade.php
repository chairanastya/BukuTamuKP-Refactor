...
<div id="rejectModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <textarea id="alasanBatal" class="w-full border border-gray-300 rounded-lg p-3 mb-4" rows="4" placeholder="Alasan pembatalan..."></textarea>
...
<script>
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        return data 
                            ? `<a href="${data}" target="_blank" class="text-blue-600 hover:underline">Lihat</a>`
                            : '-';
                    }
                },
                { data: 'instansi' },
    ...
    function viewHasil(id) {
        ...
        // TODO: redirect to notulensi page
        // window.location.href = `/resepsionis/kunjungan/${id}/notulensi`;
    }
