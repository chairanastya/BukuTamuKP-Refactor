        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                ...
                @if($notulensi->kunjungan->karyawan->count() == 1)
                    <div class="input-wrapper">
                        <input type="text" value="{{ $notulensi->kunjungan->karyawan->first()->nama_karyawan }} - {{ $notulensi->kunjungan->karyawan->first()->jabatan }}" readonly>
                    </div>
                @else
            ...
            <div>
                ...
                <div class="input-wrapper">
                    <input type="text" value="{{ \Carbon\Carbon::parse($notulensi->kunjungan->tanggal_kunjungan)->format('l, d F Y') }}" readonly>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
                    <p class="text-yellow-800 text-sm">
                        <strong>Catatan:</strong> Notulensi ini bersifat read-only dan tidak dapat diubah. Jika ada kesalahan atau perlu perubahan, silakan hubungi karyawan yang bersangkutan.
                    </p>
                </div>
            </div>
            ...
            <!-- Button -->
            <div class="lg:col-span-2">
                <a href="{{ url('/') }}" class="block w-full text-center bg-[#084E8F] hover:bg-[#F7B218] text-white font-bold py-3 px-6 rounded-lg transition duration-200 shadow-lg hover:shadow-xl">
                    Kembali ke Beranda
                </a>
            </div>
        </div>
...
<div id="karyawan_modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <div class="px-1">
            <p class="text-gray-600 mb-4">Total {{ $notulensi->kunjungan->karyawan->count() }} karyawan yang terlibat dalam kunjungan ini:</p>
            <div class="space-y-3">
