            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if($kunjungan->karyawan->count() == 1)
                        <div class="input-wrapper readonly">
                            <input type="text" value="{{ $kunjungan->karyawan->first()->nama_karyawan }} - {{ $kunjungan->karyawan->first()->jabatan }}" readonly>
                        </div>
                    @else
                        <div class="input-wrapper" style="padding: 0; overflow: hidden;">
                            <button type="button" onclick="openKaryawanModal()" class="w-full bg-[#084E8F] hover:bg-[#F7B218] text-white font-semibold py-2 px-4 transition flex items-center justify-center gap-2">
                ...
                <div>
                    ...
                    <div class="input-wrapper readonly">
                        <input type="text" value="{{ \Carbon\Carbon::parse($kunjungan->tanggal_kunjungan)->format('l, d F Y') }}" readonly>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <div class="input-wrapper flex-1">
                            <input type="time" name="jam_selesai" value="{{ old('jam_selesai', $kunjungan->jam_selesai) }}" required>
                        </div>
                    </div>
                    @error('jam_selesai')
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="input-wrapper">
                        <textarea 
                            ...
                            id="anggota_rapat" 
                            rows="4"
                            placeholder="Sebutkan anggota lain yang hadir jika ada..."
                        >{{ old('anggota_rapat') }}</textarea>
                    </div>
                    @error('anggota_rapat')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="input-wrapper">
                        <textarea 
                            ...
                            rows="12" 
                            required
                            placeholder="Tuliskan ringkasan pembahasan, keputusan yang diambil, dan tindak lanjut yang diperlukan..."
                        >{{ old('isi_notulensi') }}</textarea>
                    </div>
                    @error('isi_notulensi')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-sm mt-2">Minimal 50 karakter. Sertakan detail lengkap untuk dokumentasi yang baik.</p>
                </div>
                ...
                <!-- Submit Button -->
                <div class="lg:col-span-2">
                    <button type="submit" class="w-full bg-[#084E8F] hover:bg-[#F7B218] text-white font-bold py-3 px-6 rounded-lg transition duration-200 shadow-lg hover:shadow-xl">
                        Simpan Notulensi
                    </button>
                </div>
            </div>
...
<div id="karyawan_modal" class="modal-overlay">
    <div class="modal-content">
        ...
        <div class="px-1">
            <p class="text-gray-600 mb-4">Total {{ $kunjungan->karyawan->count() }} karyawan yang terlibat dalam kunjungan ini:</p>
            <div class="space-y-3">
            ...
            <div class="mt-6">
                <button type="button" onclick="closeKaryawanModal()" class="w-full bg-[#084E8F] hover:bg-[#F7B218] text-white font-bold py-3 px-4 rounded-lg transition">
                    Tutup
                </button>
            </div>
        </div>
